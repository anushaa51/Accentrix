...
model.add(Dense(state_size_1, input_shape = (25,), kernel_initializer=initializer))

model.add(Dense(state_size_2, kernel_initializer=initializer))
model.add(Activation("relu"))
model.add(BatchNormalization())

model.add(Dense(state_size_3, kernel_initializer=initializer))
model.add(Activation("relu"))
model.add(BatchNormalization())

model.add(Dense(state_size_4, kernel_initializer=initializer))

optimizer = SGD(lr = lr, momentum=0.3)
