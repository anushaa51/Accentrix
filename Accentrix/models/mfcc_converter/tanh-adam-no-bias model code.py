...
model.add(Dense(state_size_1, input_shape = (25,), kernel_initializer=initializer, use_bias=False))

model.add(Dense(state_size_2, kernel_initializer=initializer, use_bias=False))
model.add(Activation("tanh"))

model.add(Dense(state_size_3, kernel_initializer=initializer, use_bias=False))
model.add(Activation("tanh"))

model.add(Dense(state_size_4, kernel_initializer=initializer, use_bias=False))
